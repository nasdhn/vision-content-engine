...
export const PatternVersionSpecSchema = z
  .object({
    identity: z
      .object({
      ...
      .object({
        ...
        cta: z
          .object({
            ...
            tone: z.string().min(1),
            placementGuidance: z.enum(['EARLY', 'MIDDLE', 'END', 'CONTEXT_DEPENDENT']),
...
export const PatternEvidenceSnapshotSchema = z
  .object({
    patternVersionId: z.string().uuid(),
