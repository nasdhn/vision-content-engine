...
export const RecordingRequestSpecSchema = z
  .object({
    clientKey: z.string().min(1),
    type: z.enum(['VOICE', 'GREEN_SCREEN_VIDEO', 'SCREEN_VIDEO', 'BROLL', 'OTHER']),
...
export const CaptureRequestSpecSchema = z
  .object({
    clientKey: z.string().min(1),
...
export const CreativeDirectorInputSchema = z
  .object({
    ...
    editingProfileCandidates: z.array(
      z
        .object({
    ...
    captureScenarioCandidates: z.array(
      z
        .object({
          captureScenarioVersionId: UuidSchema,
...
export const CreativeDirectorOutputSchema = z
  .object({
    script: z
      .object({
        ...
        voiceMode: z.enum(['NATURAL_USER_VOICE', 'NO_VOICE', 'OTHER_HUMAN']),
      })
      .strict(),
    ...
    creativePlan: z
      .object({
        ...
        cta: z
          ...
          .strict(),
        platformConsiderations: z.array(
          z
            .object({
