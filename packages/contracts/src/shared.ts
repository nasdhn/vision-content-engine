...
export const VerifiedClaimSchema = z
  .object({
    id: z.string().min(1),
    text: z.string().min(1),
    type: z.enum(['PRODUCT_FACT', 'PRICING_FACT', 'BUSINESS_FACT', 'EXTERNAL_STAT']),
...
export const ProposedClaimSchema = z
  .object({
    text: z.string().min(1),
    type: z.enum(['PRODUCT_FACT', 'PRICING_FACT', 'EXTERNAL_STAT', 'OPINION', 'EXPERIENCE']),
    verifiedClaimIds: z.array(z.string().min(1)),
    disposition: z.enum(['VERIFIED', 'HUMAN_REVIEW_REQUIRED']),
  })
  .strict();
...
export const TargetCustomerSchema = z
  .object({
    id: z.string().min(1),
...
export const CTAOptionSchema = z
  .object({
    id: z.string().min(1),
    type: z.string().min(1),
    text: z.string().min(1),
...
export const BrandKnowledgeSnapshotSchema = z
  .object({
    id: UuidSchema,
    key: z.string().min(1),
...
export const ConceptVersionSnapshotSchema = z
  .object({
    id: UuidSchema,
...
export const PatternVersionSnapshotSchema = z
  .object({
    id: UuidSchema,
...
export const ScriptVersionSnapshotSchema = z
  .object({
    id: UuidSchema,
    scriptId: UuidSchema,
    ...
    voiceMode: z.enum(['NATURAL_USER_VOICE', 'NO_VOICE', 'OTHER_HUMAN', 'AI_VOICE']),
  })
  .strict();

export const CreativePlanVersionSnapshotSchema = z
  .object({
    id: UuidSchema,
...
export const EditingProfileVersionSnapshotSchema = z
  .object({
    id: UuidSchema,
    key: z.string().min(1),
    version: z.number().int().positive(),
...
export const TemplateVersionSnapshotSchema = z
  .object({
    id: UuidSchema,
    key: z.string().min(1),
    version: z.number().int().positive(),
...
export const ContentMemoryItemSchema = z
  .object({
    conceptVersionId: UuidSchema,
