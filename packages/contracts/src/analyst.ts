...
import { PlatformSchema, PrimaryFormatSchema, UuidSchema } from './shared.js';

export const AnalystPublicationSchema = z
  .object({
...
export const AnalystExperimentSchema = z
  .object({
...
export const AnalystPriorInsightSchema = z
  .object({
    insightId: UuidSchema,
    statement: z.string().min(1),
    confidence: z.enum(['INSUFFICIENT_DATA', 'WEAK_SIGNAL', 'INTERESTING_SIGNAL', 'FAIRLY_SOLID']),
    limitations: z.array(z.string()),
  })
  .strict();
...
export const AnalystInputSchema = z
  .object({
    ...
    priorInsights: z.array(AnalystPriorInsightSchema),
    attributionSignals: z
      .object({
...
export const AnalystInsightSchema = z
  .object({
    statement: z.string().min(1),
    confidence: z.enum(['INSUFFICIENT_DATA', 'WEAK_SIGNAL', 'INTERESTING_SIGNAL', 'FAIRLY_SOLID']),
...
export const AnalystRecommendationSchema = z
  .object({
...
export const AnalystOutputSchema = z
  .object({
    insights: z.array(AnalystInsightSchema),
